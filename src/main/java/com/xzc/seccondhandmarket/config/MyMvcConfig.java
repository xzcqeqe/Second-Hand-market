...
public  class  MyMvcConfig implements WebMvcConfigurer{
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/admin").setViewName("adminLogin");//默认管理员登录首页
        ...
        registry.addViewController("/admin/login.html").setViewName("adminLogin");//管理员登录请求转管理员登录
        registry.addViewController("/main.html").setViewName("adminLogin");//管理员登录请求转管理员登录
    }
